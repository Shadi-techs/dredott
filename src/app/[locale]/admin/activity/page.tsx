        ...
        <>
          ...
          {tab === 'overview' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              ...
              {subAdmins.map(admin => (
                <div key={admin.id} style={{ background: '#1a2240', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 14 }}>
                  {/* Summary row */}
          ...
          {tab === 'sessions' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              {sessions.length === 0 ? (
                ...
                const Icon = cfg.icon
                return (
                  <div key={s.id} style={{ background: '#1a2240', border: '1px solid rgba(255,255,255,0.04)', borderRadius: 10, padding: '12px 16px', display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          {tab === 'actions' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              {actions.length === 0 ? (
                ...
                const Icon = cfg.icon
                return (
                  <div key={a.id} style={{ background: '#1a2240', border: '1px solid rgba(255,255,255,0.04)', borderRadius: 10, padding: '12px 16px', display: 'flex', alignItems: 'center', gap: 12 }}>
                    <Icon size={16} color={cfg.color} />
                    <div style={{ flex: 1 }}>
