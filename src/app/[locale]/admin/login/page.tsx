...
// ============================================
// Admin Login Page
// Path: src/app/[locale]/admin/login/page.tsx
//
// ✅ بتكلم /api/admin/login مباشرة
// ✅ مش بتستخدم Supabase Auth
// ✅ الـ JWT بيتحط في httpOnly cookie من الـ API
// ============================================
...
export default function AdminLoginPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // نجح — الـ JWT اتحط في cookie تلقائياً من الـ API
      // روح لصفحة الـ PIN
      ...
      <div className="relative w-full max-w-md">
        <div className="bg-[#1a2240] rounded-2xl shadow-2xl border border-[#D4A843]/20 p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-[#FBF0D0] mb-2">White Stork Admin</h1>
