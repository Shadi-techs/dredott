...
const EMPTY_FORM = {
  ...
  bg_color: '#F0F2F7', text_color: '#FBF0D0', cta_color: '#D4A843',
  starts_at: '', ends_at: '',
}
    ...
    <div style={{ minHeight: '100vh', background: '#F0F2F7', padding: '28px 32px' }}>
      ...
      {showEditor && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.8)', zIndex: 50, display: 'flex', alignItems: 'flex-start', justifyContent: 'center', padding: '40px 24px', overflowY: 'auto' }}>
          <div style={{ background: '#1e2d4f', border: '1px solid rgba(212,168,67,0.2)', borderRadius: 16, width: '100%', maxWidth: 600, padding: 28 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              <button onClick={handleSave} disabled={saving} style={{
                marginTop: 8, padding: 12, background: '#D4A843', color: '#F0F2F7',
