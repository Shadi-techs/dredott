...
export default function AdminBlogPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F0F2F7', padding: 24 }}>
      ...
      {showEditor && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.8)', zIndex: 50, display: 'flex', alignItems: 'flex-start', justifyContent: 'center', padding: '40px 24px', overflowY: 'auto' }}>
          <div style={{ background: '#1e2d4f', border: '1px solid rgba(212,168,67,0.2)', borderRadius: 16, width: '100%', maxWidth: 720, padding: 28 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              <div style={{ display: 'flex', gap: 10, paddingTop: 8 }}>
                ...
                <button onClick={() => handleSave(true)} disabled={saving} style={{
                  padding: '10px 20px', background: '#D4A843', color: '#F0F2F7',
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          {posts.map(post => (
            <div key={post.id} style={{
              background: '#1e2d4f', border: '1px solid rgba(212,168,67,0.08)',
