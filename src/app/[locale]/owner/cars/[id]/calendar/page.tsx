// ============================================
// Car Calendar Page
// Path: src/app/[locale]/owner/cars/[id]/calendar/page.tsx
// Manage blocked dates for car
// ============================================
...
export default function CarCalendarPage({ params }: CarCalendarProps) {
  ...
  const fetchCar = async () => {
    try {
      ...
      if (error || !data) {
        setError('Car not found or access denied')
        setLoading(false)
        return
      }
    ...
    <div className="p-6 lg:p-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Block dates when your car is unavailable for rental
        </p>
      </div>
      ...
      <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        ...
        <ul className="text-sm text-blue-800 space-y-1">
          ...
          <li>• Common reasons: Maintenance, Personal use, Already rented</li>
